...
class LMForSequenceClassification(pl.LightningModule):
    def __init__(
        ...
        self.test_F1 = torchmetrics.F1Score(task='binary', num_classes=2, average="macro")
        self.test_prec = torchmetrics.Precision(task='binary', num_classes=2, average="macro")
        self.test_rec = torchmetrics.Recall(task='binary', num_classes=2, average="macro")
    ...
    def training_epoch_end(self, training_step_outputs):
        ...
        self.log("train_acc", train_accuracy)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.test_prec.update(y_pred, y_true)
        self.test_rec.update(y_pred, y_true)
    ...
    def test_epoch_end(self, test_step_outputs):
        ...
        self.log("test_prec", test_precision)
        self.log("test_rec", test_recall)
        self.test_acc.reset()
        self.test_F1.reset()
